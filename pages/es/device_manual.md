...
Los datos generados por los Monitores CanAirIO se pueden consultar en el mapa
 : [http//daquina/canairio](http://daquina.io/canairio/) aporte de la comunidad  [Un/loquer](https://unloquer.org/) y las lineas de tiempo de los datos se visualizan en  https://grafana.canair.io/
<br>
<br>
...
8. Grafana Estaciones Fijas https://grafana.canair.io/d/xRQpZACWk/fixed-stations?orgId=1&refresh=5s  
